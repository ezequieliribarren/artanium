          ...
          <div className="row">
            ...
            <div className='col-12 col-lg-6'>
              ...
              <div className="ul-products">
                <ul>
                  <li> <div className='products-a'><strong>{magnetico.a1}</strong></div> <div className='products-b'>{magnetico.b1}</div> <div className='products-c'><img src={magnetico.c1} alt="" /></div>  </li>
                  <li> <div className='products-a'><strong>{magnetico.a2}</strong></div> <div className='products-b'>{magnetico.b2}</div> <div className='products-c'><img src={magnetico.c2} alt="" /></div>  </li>
                  <li> <div className='products-a'><strong>{magnetico.a3}</strong></div> <div className='products-b'>{magnetico.b3}</div> <div className='products-c'><img src={magnetico.c3} alt="" /></div>  </li>
                </ul>
              </div>
              <div className="line"></div>
            </div>
