          ...
          <div className="row">
            ...
            <div className='col'>
              <div className='products-subtitles'>
                <span className='ico-h4'><img src={resinado.imgtop} alt="Papeles" /></span>{resinado.subtitulo1}<h4>{resinado.subtitulo}</h4>{resinado.subtitulo2}
              </div>
              <div className="line"></div>
              <div className="ul-products">
                <ul>
                  <li> <div className='products-a'><strong>{resinado.a1}</strong></div> <div className='products-b'>{resinado.b1}</div> <div><img src={resinado.c1} alt="" /></div>  </li>
                  <li> <div className='products-a'><strong>{resinado.a2}</strong></div> <div className='products-b'>{resinado.b2}</div> <div><img src={resinado.c2} alt="" /></div>  </li>
                  <li> <div className='products-a'><strong>{resinado.a3}</strong></div> <div className='products-b'>{resinado.b3}</div> <div><img src={resinado.c3} alt="" /></div>  </li>
                </ul>
              </div>
              <div className="line"></div>
            </div>
