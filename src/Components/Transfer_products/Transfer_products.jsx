          ...
          <div className="row cols-transfer">
            ...
            <div className='col'>
              ...
              <div className="ul-subli">
                <ul>
                  <li> <div className='subli-a'><strong>{transfer.a1}</strong></div> <div className='subli-b'>{transfer.b1}</div> <div className='products-c'><img src={transfer.c1} alt="" /></div>  </li>
                  <li> <div className='subli-a'><strong>{transfer.a2}</strong></div> <div className='subli-b'>{transfer.b2}</div> <div className='products-c'><img src={transfer.c2} alt="" /></div>  </li>
                  <li> <div className='subli-a'><strong>{transfer.a3}</strong></div> <div className='subli-b'>{transfer.b3}</div> <div className='products-c'><img src={transfer.c3} alt="" /></div>  </li>
                </ul>
              </div>
              <div className="line"></div>
